...
def aug_topology(sim_mx, input_graph, percent=0.2):
    ...
    :param input_graph: tensor, adjacency matrix without self-loop, [v,v]原始交通流量图 G (num_nodes, num_nodes)
    :return aug_graph: tensor, augmented adjacency matrix on cuda, [v,v]增广交通流量图 G_tilde (num_nodes, num_nodes)
    """
...
def aug_traffic(t_sim_mx, flow_data, percent=0.2):
    ...
    :param flow_data: input flow data, [n,l,v,c] X_tilde (batch_size, time_steps, num_nodes, feature_dim)
    """
